  ...
  onSubmit() {
    switch (this.dbOps) {
      case DBOperations.create:
        this._dataService.post(environment.BASE_API_PATH + 'UserType/Save/', this.addForm.value).subscribe((res) => {
          if (res.isSuccess) {
            this._toastr.success("Data saved successfully", "UserType Master");
            this.resetForm();
          } else {
            this._toastr.error(res.errors[0], "UserType Master");
          }
      ...
      case DBOperations.update:
        this._dataService.post(environment.BASE_API_PATH + 'UserType/Update/', this.addForm.value).subscribe((res) => {
          if (res.isSuccess) {
    ...
    Swal.fire(
      {
        ...
        if (result.value) {
          this._dataService.post(environment.BASE_API_PATH + 'UserType/Delete/', obj).subscribe((res) => {
            if (res.isSuccess) {
              //this._toastr.success("Data Deleted successfully", "UserType Master");

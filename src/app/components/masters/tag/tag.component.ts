  ...
  onSubmit() {
    switch (this.dbOps) {
      case DBOperations.create:
        this._dataService.post(environment.BASE_API_PATH + 'TagMaster/Save/', this.addForm.value).subscribe((res) => {
          if (res.isSuccess) {
      ...
      case DBOperations.update:
        this._dataService.post(environment.BASE_API_PATH + 'TagMaster/Update/', this.addForm.value).subscribe((res) => {
          if (res.isSuccess) {
    ...
    Swal.fire(
      {
        ...
        if (result.value) {
          this._dataService.post(environment.BASE_API_PATH + 'TagMaster/Delete/', obj).subscribe((res) => {
            if (res.isSuccess) {
